    ...
    return(
      ...
      <section className="col-12" id="crowdsale_wrap">
        ...
        <div className="row no-gutters" >
            ...
            <Particles retinaDetect="true" className="col-12" style={{position:'relative' , height:'40vh' , zIndex:100, top:0 , left:0 }} params={{
            ...
            <div className=" col-12" id="crowd" style={{position:'absolute' , zIndex:1000000000}}>
...
13 December 2017 14:00 UTC</p>
                        ...
                        <img src={logo} alt="" className="col-2 mx-auto align-self-center" id="logo" />
